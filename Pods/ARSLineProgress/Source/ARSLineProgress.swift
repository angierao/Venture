...
final public class ARSLineProgressConfiguration: NSObject {
    ...
    public static func restoreDefaults() {
        ...
        ars_config.circleColorOuter = UIColor.ars_colorWithRGB(102.0, green: 102.0, blue: 255.0, alpha: 1.0).CGColor
        ars_config.circleColorMiddle = UIColor.ars_colorWithRGB(204.0, green: 204.0, blue: 255.0, alpha: 1.0).CGColor
        ars_config.circleColorInner = UIColor.ars_colorWithRGB(102.0, green: 102.0, blue: 153.0, alpha: 1.0).CGColor
